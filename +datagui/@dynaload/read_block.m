...
% ex:
%
% 1: % $Id: read_block.m 226 2013-01-29 16:54:48Z jgrelet $
...
% 
% $Id: read_block.m 226 2013-01-29 16:54:48Z jgrelet $
...
while (1)
  ...
  if isempty(match)
    ...
    error(['missing #; at begining or ;# at end of line: ' ...
      int2str(self.line+blk_size+2) ' in ' self.Filename ...
      ', ... Check your file']);
  end
  ...
  for j=1:nb_members
    ...
    try
      ...
      error(['mismatch field number in ' self.Filename ', line: ' ...
