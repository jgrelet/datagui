%% datagui.hashtable class
%
% This class implement a hashtable and is part of datagui package (namespace)
% h = datagui.hashtable(keys, values)
%
% datagui.hashtable use same syntax than Matlab containers.Map object with
% some useful get and put method, give logical indexing.
% Instead of MATLAB containers.Map, datagui.hashtable lists keys in the order
% they are enter by default.
%
% datagui.hashtable is a part of package datagui, use fully qualified
% package name like datagui.hashtable or use 'import datagui' directive first
...
% h.c = s
%
% class datagui.hashtable <a href="matlab:methods('datagui.hashtable')">methods</a>
%
% Writen for Matlab(R) 7.6 by J Grelet (Jacques.Grelet_at_ird.fr) US191 - IRD 
% adapted from Matthew Krauski hashtable (mkrauski_at_uci.edu), CNLM, UC
% Irvine
%
% $Id: hashtable.m 246 2013-02-05 05:01:23Z jgrelet $
    ...
    function self = hashtable(varargin)
      ...
      elseif nargin == 2
        ...
        try
          ...
          % construct hashtable from key/value pair
          % ------------------------------------------
