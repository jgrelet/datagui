...
% datagui.ncdump -- List NetCDF file headers as NetCDF Language.
%  datagui.ncdump(theNetCDFFile, 'theOutputFile') displays the
...
%
% $Id: ncdump.m 234 2013-01-31 21:50:21Z jgrelet $
...
% get key and structure from Dimensions
...
for key = keys(nc, 'Variables')
  ...
  % loop over fieldnames (variable attributes)
  % ------------------------------------------
