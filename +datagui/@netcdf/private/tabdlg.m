...
%   $Revision: 1.19.4.11 $  $Date: 2008/06/24 17:15:16 $
...
switch(Action),
    ...
    otherwise,
        error('MATLAB:tabdlg:InvalidAction', 'Invalid action.');
end
        ...
        if hfig == -1,
          ...
          hfig = figure( ...
            ...
            if (isequal(get(hfig,'WindowStyle'), 'docked'))
                error('MATLAB:tabdlg:NoDockedFigures', ...
                         'tabdlg does not work with docked figures');
            end
	  ...
	  % buttonPanelOffset = buttonPanelHeight + 5 (number of pixels between 
        ...
        for i = 1:numTabs,
            ...
            c = uicontrol(tabs(i), ...
                ...
                'HorizontalAlign',  get(htmp,'HorizontalAlign'), ...
