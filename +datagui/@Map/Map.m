%% datagui.Map class
% datagui.Map  Provide access to containers.Map (hashtable with key/value pair).
%
...
%
% example:
% m = datagui.Map('TEMP', struct('data__', 21.56, 'long_name', 'Temperature'))
%  Properties:
...
% 	  ValueType: [any]
%
% $Id: Map.m 203 2013-01-22 15:15:17Z jgrelet $
  ...
  methods
    ...
    function set.MagicField(self, value)
      if (~isempty(value)) && (~ischar(value)) 
        error('datagui:Map', 'datagui.Map:set.MagicField: property must be a string')
      end
    ...
    function set.AutoAccess(self, value)
      ...
      if (~islogical(value)) 
        error('datagui:Map', 'datagui.Map:set.AutoAccess: property must be a boolean')
      end
    ...
    function display(self)
      ...
      fprintf(['\n  <a href="matlab:help datagui.Map">datagui.Map</a> ' ...
