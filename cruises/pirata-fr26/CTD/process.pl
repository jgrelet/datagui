...
my $cruise   = 'pirata-fr26';
my $fileName = "fr26%03d";
...
sub usage() {
  ...
  print STDERR   "    --pmel                process realtime data for CODAC\n";
  ...
  print STDERR "\nexample: perl m:\\PIRATA-FR26\\data-processing\\CTD\\process.pl 001\n\n";
  print STDERR "\nexample: perl m:\\PIRATA-FR26\\data-processing\\CTD\\process.pl 001 040 --std\n\n";
