function rmpathdef_datagui
% rmpathdef_datagui
% remove sub-directories from matlabpath 

% $Id: rmpathdef_datagui.m 188 2012-10-03 14:25:01Z jgrelet $
...
rmpath( [pathHome filesep 'util'] );
rmpath( [pathHome filesep 'callback'] );
rmpath( [pathHome filesep 'common'] );
