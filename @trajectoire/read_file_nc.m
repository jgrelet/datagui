function [self nc] = read_file_nc( self, varargin )
% read_file_nc( self, varargin )
%
...
% $Id: read_file_nc.m 131 2007-03-16 14:45:36Z jgrelet $
    ...
    for i = 1:length(variables)
      ...
      switch cle
        ...
        case {'PROFILE','PROFILS', 'PRFL', 'ST'}
          ...
          self = set( self, 'data_1d', cle, valeur);
        case {'DAYD', 'LATX', 'LONX'}
          if (root.medianSize > 0 ); valeur = medianf( valeur, root.medianSize ); end 
          self = set( self, 'data_1d', cle, valeur);
        otherwise
...
% ---------------------------------------
  function read_netcdf_native
    ...
    if (root.medianSize > 0 )
      ...
      fprintf('...find %d records ', length(valeur) );
    end
  end
